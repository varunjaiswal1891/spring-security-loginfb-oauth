...
* The original package name 'io.javabrains.varun.spring-security-login-fb-oauth' is invalid and this project uses 'io.javabrains.varun.springsecurityloginfboauth' instead.
